    ...
    data: [
      {
        ...
        released: "1993",
        image: "https://static.cloud.noroff.dev/public/old-games/the-incredible-machine.png",
        genre: ["Puzzle"]
      },
      {
        slug: "lemmings",
        ...
        released: "1991",
        image: "https://static.cloud.noroff.dev/public/old-games/lemmings.gif",
        genre: ["Action", "Puzzle"]
      }
    ]
  })
...
describe("[GET] /v2/old-games/:id", () => {
  ...
  it("should return 404 if old game not found", async () => {
    ...
    expect(res.errors[0].message).toBe("No old game with such ID")
  })
