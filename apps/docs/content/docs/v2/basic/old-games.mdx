...
<TypeTable
  type={{
    ...
    image: { type: "object", typeDescription: "Instance of `Media` model.", description: "Image of the game." },
  ...
  "data": [
    {
      ...
      "released": "1993",
      "image": {
        "url": "https://static.cloud.noroff.dev/api/old-games/the-incredible-machine.png",
        "alt": "The Incredible Machine"
      },
      "genre": ["Puzzle"]
    },
    {
      ...
      "released": "1991",
      "image": {
        "url": "https://static.cloud.noroff.dev/api/old-games/lemmings.gif",
        "alt": "Lemmings"
      },
      "genre": ["Action", "Puzzle"]
    }
...
```json title="Response"
{
  "data": {
    ...
    "released": "1991",
    "image": {
      "url": "https://static.cloud.noroff.dev/api/old-games/street-rod-2-the-next-generation.gif",
      "alt": "Street Rod 2: The Next Generation"
    },
