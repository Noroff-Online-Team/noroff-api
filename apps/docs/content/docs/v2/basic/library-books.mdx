---
title: Library Books
description: Library Books endpoint for Personal Digital Book Library (PDBL)
---
...
<EndpointDetails path="/library-books" />
...
<EndpointDetails path="/library-books/<id>" />
...
<EndpointDetails method="POST" path="/library-books" />
...
<EndpointDetails method="PUT" path="/library-books/<id>" />
...
<EndpointDetails method="DELETE" path="/library-books/<id>" />
...
<EndpointDetails path="/library-books/<id>/reviews" />

Retrieve all reviews for a specific library book.
...
```json title="Response"
{
  "data": [
    {
      "id": "review-id-1",
      "comment": "Absolutely loved this book! A must-read classic that deals with important themes.",
      "rating": 5,
      "reviewer": {
        "name": "jane_smith",
        ...
        "avatar": {
          "url": "https://example.com/jane-avatar.jpg",
          "alt": "Jane's avatar"
        },
        "banner": {
          "url": "https://example.com/jane-banner.jpg",
          "alt": "Jane's banner"
        }
      },
      "book": {
    ...
    {
      "id": "review-id-2",
      "comment": "Great story, though some parts felt a bit slow. Still worth reading.",
      "rating": 4,
      "reviewer": {
        "name": "book_lover",
        "email": "reader@example.com",
        "bio": "Reading 100 books this year!",
        "avatar": {
          "url": "https://example.com/reader-avatar.jpg",
          "alt": "Reader's avatar"
        }
      },
      "book": {
      ...
      "updated": "2025-01-02T08:30:00.000Z"
    }
    // ...
  ],
  "meta": {
...
<EndpointDetails path="/library-books/<id>/reviews/<reviewId>" />

Retrieve a single review by its id for a specific book.
...
<EndpointDetails method="POST" path="/library-books/<id>/reviews" />
...
<EndpointDetails method="PUT" path="/library-books/<id>/reviews/<reviewId>" />
...
<EndpointDetails method="DELETE" path="/library-books/<id>/reviews/<reviewId>" />

Delete a review by its id. Only the author of the review can delete it.
