const classes = {
  ...
  PATCH: "ring-yellow-300 dark:ring-yellow-500/30 bg-yellow-400/10 text-yellow-700 dark:text-yellow-300",
  DELETE: "ring-red-300 dark:ring-red-500/30 bg-red-400/10 text-red-700 dark:text-red-300"
}
...
export function EndpointDetails({
  ...
  return (
    <div className="flex items-center gap-x-2 mt-4 font-semibold font-mono ">
      ...
      <span className="font-medium tracking-tight text-zinc-700 dark:text-zinc-300">{path}</span>
    </div>
  )
}
